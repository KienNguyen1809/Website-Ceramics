<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="http://localhost/GomSu/public/"><i class="fa fa-dashboard fa-fw"></i> Trang chủ</a>
            </li>
            ...
            <li>
                <a href="admin/loaisanpham/danhsach"><i class="fa fa-cube fa-fw"></i> DANH MỤC SẢN PHẨM<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
