...
|route:get('url/{param}/{param}',action)
*/
// home page
Route::get('/',[
	'as'=>'index',
...
Route::post('index','PageController@postMail');
// all product
Route::get('store',[
	'as'=>'store',
...
Route::get('promotion',[
	'as'=>'promotion',
	'uses'=>'pageController@getPromotion'
]);
// brand find
Route::get('store/{id}',[
	'as'=>'brand',
...
Route::group(['prefix'=>'admin','middleware'=>'adminLogin'],function(){
	...
	Route::group(['prefix'=>'comment'],function(){
		Route::get('xoa/{id}/{idproduct}','commentController@getDelete');
	});
	...
	{
		// admin/users/danh sách||them||sua
...
// email
//Route::get('send-email',['as'=>'getSendemail','users'=>'WelcomeController@get_sendemail']);
//Route::post('send-email',['as'=>'postSendemail','users'=>'WelcomeController@post_sendemail']);
